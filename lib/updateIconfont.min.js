(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('url'), require('path'), require('http'), require('https'), require('stream'), require('assert'), require('tty'), require('util'), require('os'), require('zlib')) :
  typeof define === 'function' && define.amd ? define(['fs', 'url', 'path', 'http', 'https', 'stream', 'assert', 'tty', 'util', 'os', 'zlib'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['update-ali-iconfont'] = factory(global.fs, global.url, global.path, global.http, global.https, global.stream, global.assert, global.tty, global.util, global.os, global.zlib));
}(this, (function (fs, url, path, http, https, stream, assert, tty, util, os, zlib) { 'use strict';
  ...
  class UpdateIconfont {
    ...
    init () {
      ...
      axios$1.get(this.handleUrl(url), {
        headers: {
          Cookie: cookie
        }
      }).then(response => {
