(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('url'), require('path'), require('http'), require('https'), require('stream'), require('assert'), require('tty'), require('util'), require('net'), require('zlib')) :
  typeof define === 'function' && define.amd ? define(['fs', 'url', 'path', 'http', 'https', 'stream', 'assert', 'tty', 'util', 'net', 'zlib'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.updateIconfont = factory(global.fs, global.url, global.path, global.http, global.https, global.stream, global.assert, global.tty, global.util, global.net, global.zlib));
}(this, (function (fs, url, path, http, https, stream, assert, tty, util, net, zlib) { 'use strict';
  ...
  var _from = "axios@^0.16.2";
  var _id = "axios@0.16.2";
  var _inBundle = false;
  var _integrity = "sha1-uk+S8XFn37q0CYN4VFS5rBScPG0=";
  var _location = "/axios";
  ...
  var _resolved = "https://registry.npm.taobao.org/axios/download/axios-0.16.2.tgz?cache=0&sync_timestamp=1594827610645&other_urls=https%3A%2F%2Fregistry.npm.taobao.org%2Faxios%2Fdownload%2Faxios-0.16.2.tgz";
  var _shasum = "ba4f92f17167dfbab40983785454b9ac149c3c6d";
  var _spec = "axios@^0.16.2";
  var _where = "/Users/btoa/Desktop/node";
  var author = {
  	name: "Matt Zabriskie"
  };
  var browser$1 = {
  ...
  class UpdateIconfont {
    ...
    init () {
      let { config } = this;
      axios$1.get(this.handleUrl(config.url), {
        headers: {
